...
import { Card, CardBody, Button, Row, Col, ListGroup } from "react-bootstrap";
    ...
    <div className="container-fluid min-vh-100 d-flex align-items-center">
      <div className="mx-auto">
        <Card className="shadow">
          <CardBody className="p-4" style={{ maxWidth: 1000 }}>
            ...
            <Card className="shadow">
              <Card.Body style={{ maxWidth: 900 }}>
                ...
                <Row>
                  <Col md={6}>
                    <Card className="mb-3">
                      ...
                      <ListGroup variant="flush">
                        ...
                        <ListGroup.Item style={{ fontSize: 12 }}>
                          ✔️ <b>Accuracy:</b> Keep data accurate and up to date.
                        </ListGroup.Item>
                        <ListGroup.Item style={{ fontSize: 12 }}>
                  ...
                  <Col md={6}>
                    <Card className="mb-3">
                      ...
                      <ListGroup variant="flush">
                        <ListGroup.Item style={{ fontSize: 12 }}>
                          ℹ️ <b>Right to Information:</b> Know how personal data
                          is used.
                        </ListGroup.Item>
                        <ListGroup.Item style={{ fontSize: 12 }}>
                          📂 <b>Right to Access:</b> Request copies of personal
                          data.
                        </ListGroup.Item>
                        <ListGroup.Item style={{ fontSize: 12 }}>
                        ...
                        <ListGroup.Item style={{ fontSize: 12 }}>
                          🚫 <b>Right to Object:</b> Oppose data processing for
                          marketing.
                        </ListGroup.Item>
                        <ListGroup.Item style={{ fontSize: 12 }}>
                          🔄 <b>Right to Data Portability:</b> Request data in a
                          portable format.
                        </ListGroup.Item>
                      </ListGroup>
                    </Card>
                  ...
                  <Card.Body>
                    <ul>
                      <li style={{ fontSize: 12 }}>
                        📌 Must register with the <b>ODPC</b> before processing
                        data.
                      </li>
                      <li style={{ fontSize: 12 }}>
                  ...
                  <Col md={6}>
                    <Card className="mb-3">
                      ...
                      <Card.Body>
                        <ul>
                          <li style={{ fontSize: 12 }}>
                            💰 Fines up to <b>KSh 5 million</b> ($50,000) or 1%
                            of annual turnover.
                          </li>
                          <li style={{ fontSize: 12 }}>
                            ⚖️ Individuals can seek <b>compensation</b> for data
                            breaches.
                          </li>
                        </ul>
                      </Card.Body>
                ...
                <Card className="mb-3">
                  ...
                  <Card.Body>
                    🛡️ National security & public interest cases may be exempted
